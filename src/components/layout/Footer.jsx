const Footer = () => {
  return (
    <footer className="footer p-10 bg-base-300 text-base-content">
      <div>
        <span className="footer-title">LocalChefBazaar</span>
        <p>Fresh homemade meals from local chefs delivered to your door.</p>
      </div>
      <div>
      ...
      <div>
        <span className="footer-title">© 2025 LocalChefBazaar</span>
